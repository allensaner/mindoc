...
#RUN mkdir -p /go/src/github.com/allensaner/ && cd /go/src/github.com/allensaner/ && git clone https://github.com/allensaner/mindoc.git && cd mindoc

ADD . /go/src/github.com/allensaner/mindoc

WORKDIR /go/src/github.com/allensaner/mindoc
...
ADD start.sh /go/src/github.com/allensaner/mindoc
...
COPY --from=build /go/src/github.com/allensaner/mindoc /mindoc
