<div class="footer">
    <div class="container">
        <div class="row text-center border-top">
            ...
            <span>&nbsp;·&nbsp;</span>
            <span><a href="https://github.com/allensaner/mindoc/issues" target="_blank">意见反馈</a></span>
            <span>&nbsp;·&nbsp;</span>
            <span><a href="https://github.com/allensaner/mindoc" target="_blank">项目源码</a></span>
            <span>&nbsp;·&nbsp;</span>
